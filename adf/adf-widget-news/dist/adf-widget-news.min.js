...
!function () {
    ...
    function logStuff(userData) {
        if (typeof userData === "string") {
            console.log("News string : " + userData);
        } else if (typeof userData === "object") {
            for (var item in userData) {
                console.log("News object : " + item + ":" + userData[item]);
    ...
    angular.module("adf.widget.news", ["adf.provider"])
        ...
        .controller("newsCtrl", ["$scope", "feed", function (e, t) {
            e.feed = t;
            // trying to add feed.title to widget.title
            if (typeof t === "object") {
                ...
                console.log("Want this widget to be named : " + e.title);
