# adf-widget-thingtodelete

thingtodelete widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-thingtodelete
...
```html
<script type="text/javascript" src="path/to/thingtodelete.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.thingtodelete']);
```
